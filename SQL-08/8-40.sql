...
inner join издательства on издательства.ид_изд = книги.издательство
where издательства.страна = 'Россия'
group by издательства.издательство, (авторы.фамилия + ' ' + авторы.имя)
order by 1
